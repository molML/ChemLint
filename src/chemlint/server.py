...
from chemlint.infrastructure.resources import get_all_resources_tools

from chemlint.tools.core import (
...
from chemlint.tools.cleaning import get_all_cleaning_tools, find_duplicates_dataset, deduplicate_dataset
...
from chemlint.tools.featurization.SMILES_encoding import get_all_smiles_encoding_tools
...
from chemlint.tools.clustering.clust import get_all_clustering_tools
for tool_func in get_all_clustering_tools():
    mcp.add_tool(tool_func)

# Add plotting tools
from chemlint.tools.plotting import get_all_plotting_tools
...
from chemlint.tools.reports import get_all_report_tools
