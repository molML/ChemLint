...
def import_excel_from_path(file_path: str, project_manifest_path: str, filename: str, explanation: str, sheet_name: int | str = 0) -> dict:
    ...
    return {
        ...
        "note": "Excel file imported and stored as CSV. Datasets are imported in a containerized directory, attempts to access the original file path may not work. Use ChemLint operations to interact with files through the manifest system after importing.",
    }
...
def get_dataset_head(project_manifest_path: str, input_filename: str, n_rows: int = 10) -> dict:
    ...
    return {
        ...
        "note": "Datasets are imported in a containerized directory, attempts to access the original file path may not work. Use ChemLint operations to interact with files through the manifest system after importing.",
